  ...
  style: {
    ...
    sources: {
      ...
      "background-gsi-raster": {
        ...
        type: "raster",
        // タイルソースのURL
        tiles: ["http://10.0.4.44/zxy/GSImaps_english2024/{z}/{x}/{y}.png"],
      ...
      "dronebird-raster": {
        ...
        type: "raster",
        // タイルソースのURL
        tiles: ["http://10.0.4.44/zxy/dronebird/{z}/{x}/{y}.png"],
        // タイルの解像度。単位はピクセル、デフォルトは512
        tileSize: 256,
        // データの帰属
        attribution: "<a href='https://openaerialmap.org/about/' target='_blank'>© OpenAerialMap/DRONEBIRD</a>",
      },
      "naturalearth": {
        type: "vector",
        // タイルが利用可能な最小ズームレベル
...
// GeolocateControl を追加
map.addControl(new maplibregl.GeolocateControl({
    positionOptions: {
        enableHighAccuracy: true
    },
    trackUserLocation: true, // ユーザーの位置を追跡する
    showUserHeading: true    // ユーザーの進行方向を表示する（対応ブラウザのみ）
}));